...
public class CallVisitor extends CallGrammarBaseVisitor<ArrayList<Sub_Call>> {
    @Override
    public ArrayList<Sub_Call> visitCall(CallGrammarParser.CallContext ctx) {
    ...
    @Override
    public ArrayList<Sub_Call> visitAtom(CallGrammarParser.AtomContext ctx) {
        if (ctx.redirection() != null)
    ...
    @Override
    public ArrayList<Sub_Call> visitLeftRedir(CallGrammarParser.LeftRedirContext ctx) {
        // The arguments in left redirection gives the inputStream.
        return getSubCallArray(new InputRedirection(visit(ctx.argument())));
    }

    @Override
    public ArrayList<Sub_Call> visitRightRedir(CallGrammarParser.RightRedirContext ctx) {
        // The arguments in right redirection gives the outputStream.
        return getSubCallArray(new OutputRedirection(visit(ctx.argument())));
    }

    @Override
    public ArrayList<Sub_Call> visitArgument(CallGrammarParser.ArgumentContext ctx) {
        ArrayList<Sub_Call> returns = new ArrayList<>();
    ...
    @Override
    public ArrayList<Sub_Call> visitSingleQuoted(CallGrammarParser.SingleQuotedContext ctx) {
        return getSubCallArray(new BaseCall(ctx.getText()));
    }

    @Override
    public ArrayList<Sub_Call> visitDoubleQuoted(CallGrammarParser.DoubleQuotedContext ctx) {
        return getSubCallArray(new BaseCall(ctx.getText()));
    }

    @Override
    public ArrayList<Sub_Call> visitBackQuoted(CallGrammarParser.BackQuotedContext ctx) {
